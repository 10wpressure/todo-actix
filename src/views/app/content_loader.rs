...
pub fn read_file(file_path: &str) -> String {
    let data: String = fs::read_to_string(file_path).expect("Could not read file");
    data
}
...
pub fn  add_component(component_tag: String, html_data: String) -> String {
    ...
    let css_path: String = String::from("./templates/components/") + &component_tag.to_lowercase() + ".css";
    let css_loaded = read_file(&css_path);
    let html_path: String = String::from("./templates/components/") + &component_tag.to_lowercase() + ".html";
